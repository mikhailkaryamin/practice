...
function Sidebar() {
  ...
  return (
    <nav className={navClass}>
      ...
      <SidebarLink href="/subscriptions" title="Уведомления" selected={currentPath === '/subscriptions'}>
        <ReactIcon src={<IoMdNotifications className="w-12 h-12 sm:w-10 sm:h-10" />} color={defineIconColor('/subscriptions')} />
      </SidebarLink>

      <SidebarLink href="/marked" title="Избранные" selected={currentPath === '/marked'}>
