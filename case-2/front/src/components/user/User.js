            ...
            <div className="collapse" id={`collapse${id}`}>
                <Card>
                    <Card.Body>
                        ...
                        <p>Телефон: <span className="fw-light fst-italic">{phone}</span></p>
                        <p>Адресс: <span className="fw-light fst-italic">{address.street} улица, {address.suite}, {address.zipcode}, {address.city}</span></p>
                    </Card.Body>
                </Card>
            </div>
            <DeleteUserModal
