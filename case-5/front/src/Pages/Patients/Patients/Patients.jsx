              ...
              patientsData.length === 0 ? (
                ...
                <>
                  <Typography variant="h6" sx={{ my: 3 }}>
                    Всего доступно пациентов: {patientsData.length}
                  </Typography>
                  <Table sx={{ minWidth: 650 }} size="small" aria-label="a dense table">
                    <TableHead>
                      <TableRow>
                        ...
                        <TableCell align="center">Имя доктора</TableCell>
                        <TableCell align="center">Цена</TableCell>
                        <TableCell align="center">Телефон пациента</TableCell>
                        <TableCell align="center">Дата приема</TableCell>
